...
class SettingsSceneMain: SKScene {
    
    var settingsHeadLabel = SKLabelNode(fontNamed: standardTextFont)
    ...
    override func didMoveToView(view: SKView!){
        ...
        settingsHeadLabel.position = CGPointMake(maximumPosition, headingPosition - 10)
        settingsHeadLabel.fontColor = deepBlueColour
        settingsHeadLabel.fontSize = 24
        settingsHeadLabel.text = "SCORES"
        self.addChild(settingsHeadLabel)
        settingsHeadLabel.runAction(moveToMidXAction)
    ...
    override func touchesBegan(touches: NSSet, withEvent event: UIEvent){
        for touch: AnyObject in touches{
            ...
            if self.nodeAtPoint(location) == self.backArrow{
                ...
                self.settingsHeadLabel.runAction(moveOutAction)
